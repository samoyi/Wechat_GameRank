    ...
    if( @mysqli_select_db($dbr, DB_NAME))
    {
        ...
        if( $result = @mysqli_query( $dbr, $query) )
        {
            function returnScore($result)
            {
                ...
                return '<td>' . $row['score'] . '分</td><td>' .  '<img src="' . $row['headimgurl'] . '" /> ' . urldecode($row['nickname']) . '</td>';
            }
            echo '
                <tr>
                    <th>名次</th>
                ...
                <tr>
                    <td>1</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>2</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>3</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>4</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>5</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>6</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>7</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>8</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>9</td>' . returnScore($result) . '
                </tr>
                <tr>
                    <td>10</td>' . returnScore($result) . '
                </tr>
